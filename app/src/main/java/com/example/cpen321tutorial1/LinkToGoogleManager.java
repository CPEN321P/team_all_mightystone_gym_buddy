        ...
        Done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (UserName.getText().toString().isEmpty()) {
                    Toast.makeText(LinkToGoogleManager.this, "Enter your username!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(LinkToGoogleManager.this, "Account Created Successfully!", Toast.LENGTH_SHORT).show();
                //Log.d("THIS IS WHAT YOURE LOOKING FOR", "CREATED ACCOUNT");
                //adding manager to database

                String Json = "";
                String JsonName = JsonFunctions.JsonName(manager.getName());
                String JsonUsername = JsonFunctions.JsonUsername(manager.getUsername());
